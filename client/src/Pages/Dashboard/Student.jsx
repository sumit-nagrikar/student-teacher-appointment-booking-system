    ...
    <>
      {spinner ? (
        ...
        <>
                  ...
                  <form onSubmit={submitHandler}>
                    ...
                    <div className="flex justify-end border-t border-gray-200 p-4">
                      ...
                      <input
                        type="submit"
                        value="Send Message"
                        className="ml-2 px-4 py-2 bg-zinc-500 text-white rounded hover:bg-blue-600"
                      // onClick={() => setShowModal(false)}
                      />
                    </div>
                  </form>
          ...
          />
          <div className="px-4 dark:bg-slate-500 dark:text-white">
            {/* info table */}
                    ...
                    >
                      <div>
                        <img
                          ...
                          alt="..."
                        />
                        <div className="w-5/6  ml-5 px-6 py-4 flex flex-col gap-4 ">
