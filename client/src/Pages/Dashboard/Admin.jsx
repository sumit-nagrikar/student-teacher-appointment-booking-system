      ...
      {spinner ? (
        ...
        <>
          <Header
            ...
            style="bg-gradient-to-r from-[#2E3A45] to-[#2E3A45]"
          />
          <section className="dark:bg-[#2E3A45] dark:text-white px-6 py-4">
            <div className=" container">
              <div className="pagecontent">
                ...
                <div className="flex justify-center text-center">
                  <div
                    className="bg-[#38B2AC] min-w-80 text-white rounded-lg shadow-lg flex flex-col justify-between h-40 "
                  ...
                  >
                    ...
                    <div className="flex justify-center border-t items-center py-2 cursor-pointer hover:bg-black-600 rounded-b-lg">
                      Add Teacher
                    </div>
                  </div>
                </div>
