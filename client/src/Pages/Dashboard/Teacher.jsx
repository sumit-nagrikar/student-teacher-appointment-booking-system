      ...
      {spinner ? (
        ...
        <>
          ...
          <Header
            ...
            style="bg-gradient-to-r bg-[#2E3A45]"
          />
          ...
          {/* dashbord container */}
          <div className="dark:bg-[#2E3A45]dark:text-white">
            <section className="container p-6  ">
              ...
              <div className="flex justify-center text-center">
                ...
                >
                  ...
                  <div className="flex justify-center border-t items-center py-2 cursor-pointer rounded-b-lg">
                    Add Schedule
                  </div>
                </div>
              </div>
