...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="dark:bg-zinc-900 bg-gray-900 sticky top-0 z-50">
        <div className="container mx-auto px-4 py-2 flex justify-between items-center">
          <Link
            className="text-white text-xl font-bold ml-36"
          ...
          <div className="flex items-center w-auto">
            {userData && (
              <span className="text-white text-lg ">Welcome, {userData}!</span>
            )}
            <button
              onClick={toggleTheme}
